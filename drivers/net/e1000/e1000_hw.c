...
static s32 e1000_copper_link_mgp_setup(struct e1000_hw *hw)
{
	...
	if (hw->phy_id != M88E1118_I_PHY_ID)
	...
	if (hw->phy_id != M88E1118_I_PHY_ID && hw->phy_revision < M88E1011_I_REV_4) {
...
static s32 e1000_copper_link_autoneg(struct e1000_hw *hw)
{
	...
	if (hw->phy_type == e1000_phy_8201
	    ...
	    || (hw->mac_type == e1000_ce4100 && hw->phy_type == e1000_phy_8211)
#endif
           )
...
static s32 e1000_phy_force_speed_duplex(struct e1000_hw *hw)
{
	...
	if ((hw->phy_type == e1000_phy_m88) && (hw->phy_id != M88E1118_I_PHY_ID)) {
