...
static struct nand_ecclayout goldfish_ecclayout = {
	.eccbytes = 4,
...
static int goldfish_nand_init_device(struct goldfish_nand *nand, int id)
{
	...
	goldfish_ecclayout.oobavail = readl(base + NAND_DEV_EXTRA_SIZE);
        goldfish_ecclayout.oobfree[0].offset = goldfish_ecclayout.eccbytes,
        goldfish_ecclayout.oobfree[0].length =
                goldfish_ecclayout.oobavail - goldfish_ecclayout.eccbytes;
	mtd->oobsize = goldfish_ecclayout.oobavail;
	mtd->oobavail = goldfish_ecclayout.oobavail;
	mtd->ecclayout = &goldfish_ecclayout;
